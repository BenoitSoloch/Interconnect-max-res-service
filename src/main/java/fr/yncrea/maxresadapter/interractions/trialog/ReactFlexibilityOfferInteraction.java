...
@Component
public class ReactFlexibilityOfferInteraction extends ReactKnowledgeInteraction {

    private final Logger log = LogManager.getLogger();
    protected ReactFlexibilityOfferInteraction(@Value("${graphpattern.flexoffer}") String argumentPattern,
